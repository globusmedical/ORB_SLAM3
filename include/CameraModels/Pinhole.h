...
#ifndef ORB_SLAM3_CAMERAMODELS_PINHOLE_H
#define ORB_SLAM3_CAMERAMODELS_PINHOLE_H
...
class Pinhole final : public GeometricCamera {
...
public:
    ...
    cv::Point2f project(const cv::Point3f& v3D);
...
#endif // ORB_SLAM3_CAMERAMODELS_PINHOLE_H
