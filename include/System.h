...
public:
    ...
    Sophus::optional<Sophus::SE3f> TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const std::vector<IMU::Point>& vImuMeas = std::vector<IMU::Point>(), std::string filename="", const Eigen::Matrix4d& T_c_drb = Eigen::Matrix4d());
