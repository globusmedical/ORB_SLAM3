...
public:
    ...
    Sophus::optional<Sophus::SE3f> GrabImageStereo(const cv::Mat &imRectLeft,const cv::Mat &imRectRight, const double &timestamp, std::string filename, const bool onlyInitWithDrb = false, const Eigen::Matrix4d &T_c_drb = Eigen::Matrix4d());
