...
public:
    ...
    Sophus::optional<Sophus::SE3f> GrabImageStereo(const cv::Mat &imRectLeft,const cv::Mat &imRectRight, const double &timestamp, std::string filename, const Eigen::Matrix4d &Tcw_seed = Eigen::Matrix4d());
...
protected:
    ...
    // World Pose seeding
    bool mbHasSeedWorldPose;
    Sophus::SE3f mTcw_seed;
